...
export default function NewVisitCaseTaking({ session, onSignOut, onReturnToDashboard, onNavigateToReviewAI }) {
      ...
      <footer className="ct-bottom-actions">
        <div className="ct-actions-inner">
          <button
            ...
            onClick={onReturnToDashboard || handleResetForm}
          >
            Cancel
          </button>
          ...
          <div className="ct-modal-card">
            ...
            <div className="ct-modal-actions">
              ...
              {onNavigateToReviewAI && (
                ...
                >
                  ✨ Proceed to Review & AI Assistance →
                </button>
              )}
