...
export default function PatientDashboard({
  ...
  // Load and sync data from MongoDB Atlas Backend & visitService & props & localStorage
  useEffect(() => {
    let isMounted = true;

    // 1. First fetch directly from MongoDB Express Backend
    getPatientDashboardFromBackend(targetId).then((res) => {
